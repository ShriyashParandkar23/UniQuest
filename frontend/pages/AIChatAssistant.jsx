  ...
  const [messages, setMessages] = useState([
    {
      id: "1",
      content:
        "I'm UniQuest AI, your personal study abroad assistant! Ask me anything about universities, applications, or scholarships.",
      sender: "ai",
      timestamp: new Date(),
      suggestions: [
  ...
  const handleSendMessage = async () => {
    ...
    try {
      ...
      const response = await axios.post(
        "http://localhost:8000/api/llm/chat/", // Update with your actual endpoint
        { message: inputValue },
            ...
            <div className="p-4 border-b flex items-center justify-between">
              <div>
                <h2 className="font-bold text-lg flex items-center text-gray-800">
                  <Bot className="h-5 w-5 mr-2 text-blue-600" /> UniQuest AI Assistant
                </h2>
